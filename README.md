<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F172A,100:2563EB&height=250&section=header&text=ASHA&fontSize=52&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Healthcare should not depend on where you live.&descAlignY=58&descAlign=50" width="100%"/>

<p align="center">
<b>"When healthcare is difficult to understand, reaching the right care becomes difficult too."</b>
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Instead of forcing users to search through complicated menus, ASHA lets them simply talk.
...
But ASHA is not designed to replace doctors.
...
Healthcare becomes much more useful when the system remembers the context of the person.
...
One of the biggest problems is not always the absence of government support.
...
The user should not need to learn how to use ASHA.
...
ASHA extends its core experience through an AI-powered voice/IVR interface.
...
Smartphone users → Full ASHA application
...
ASHA is not designed as one giant chatbot trying to do everything.

Instead, specialized AI agents can handle different responsibilities while working together.

<p align="center"> <img src="assets/agents.png" alt="ASHA Multi-Agent Architecture" width="900"/> </p>
...
<p align="center"> <img src="assets/architecture.png" alt="ASHA System Architecture" width="900"/> </p>
