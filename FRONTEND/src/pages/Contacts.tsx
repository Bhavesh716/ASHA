...
const contacts = [
  { id: 1, name: 'Sarah Wilson', role: 'Product Manager', email: 'sarah@fillow.com', phone: '+1 234 567 890', avatar: 'https://i.pravatar.cc/150?img=1' },
  { id: 2, name: 'James Chen', role: 'Developer', email: 'james@fillow.com', phone: '+1 234 567 891', avatar: 'https://i.pravatar.cc/150?img=3' },
  { id: 3, name: 'Maria Garcia', role: 'Designer', email: 'maria@fillow.com', phone: '+1 234 567 892', avatar: 'https://i.pravatar.cc/150?img=5' },
  { id: 4, name: 'Alex Johnson', role: 'Marketing', email: 'alex@fillow.com', phone: '+1 234 567 893', avatar: 'https://i.pravatar.cc/150?img=8' },
];
  ...
  return (
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800">Team Contacts</h2>
